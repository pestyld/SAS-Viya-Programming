****************************************;
* Create the products CAS table macro  *;
****************************************;
***********************************************************************;
...
%macro cre8_fake_data(nRowsPerThread=10, nThreads = 10);

proc cas;
* Number of rows to create *;
    create_nRows = &nRowsPerThread;              *<--- Enter number of rows per thread (default 10) *;
    number_of_threads_to_use = &nThreads;  *<--- Specify 'MAX' for all threads *;
